...
from models.claim import Claim, MentionSentiment
from models.pipeline import PreprocessingOutput
from scraper.fetchers.base import RawArticle
...
class PreprocessingAgent:
    def __init__(self):
        ...
        from preprocessing.claim_isolator import ClaimIsolator
    ...
    def process(self, raw: RawArticle) -> PreprocessingOutput:
        ...
        image_caption = None
        if raw.image_urls:
            caption_text = self._caption_generator.generate_caption(raw.image_urls[0])
            if caption_text:
